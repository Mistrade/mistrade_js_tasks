 ...
 *
 * @return {boolean} - Логическое значение. Вернуть true, если все числа находятся в диапазоне от min до max включительно
...
const task3result1 = checkNumbersInArray([1, 2, 3, 4, 5], 1, 10)
console.log(
