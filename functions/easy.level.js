 ...
 * Стоимость доставки на каждый последующий этаж суммируется с предыдущими этажами, например:
 * Доставка на 2-ой этаж будет 200 руб., на третий уже 400 руб., на четвертый - 600руб., а на 5-ый 900руб. и т.д.
 *
